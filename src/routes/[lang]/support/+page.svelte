...
<SEOHead title={seo.support.title} description={seo.support.description} lang={data.lang} page="support" />
				...
				{#each faqItems as item, i}
					<div class="border border-silver rounded-xl overflow-hidden">
						...
						>
							...
							<svg class="w-4 h-4 text-teal flex-shrink-0 transition-transform {openFaq === i ? 'rotate-180' : ''}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
