					...
					<table class="w-full text-sm">
						...
						<tbody>
							...
							<tr class="border-b border-white/5">
								...
								<td class="px-4 py-3 text-right text-white/50 tabular-nums"
									>{table.partTime.hours}</td
								>
								<td class="px-4 py-3 text-right text-white/50 tabular-nums"
									>{table.partTime.monthly}</td
								>
								<td class="px-4 py-3 text-right text-white/50 tabular-nums"
									>{table.partTime.annual}</td
								>
							</tr>
							<!-- Full-time row -->
							<tr class="border-b border-white/5">
								...
								<td class="px-4 py-3 text-right text-white/50 tabular-nums"
									>{table.fullTime.hours}</td
								>
								<td class="px-4 py-3 text-right text-white/50 tabular-nums"
									>{table.fullTime.monthly}</td
								>
								<td class="px-4 py-3 text-right text-white/50 tabular-nums"
									>{table.fullTime.annual}</td
								>
							</tr>
							...
							<tr class="bg-teal/10">
								...
								<td class="px-4 py-3 text-right font-bold text-teal tabular-nums"
									>{table.uboss.monthly}</td
								>
								<td class="px-4 py-3 text-right font-bold text-teal tabular-nums"
									>{table.uboss.annual}</td
								>
							</tr>
						</tbody>
					</table>
