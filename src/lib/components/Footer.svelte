		...
		<div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
			...
			<div class="md:col-span-1">
				<a href="/{lang}" class="inline-flex items-center gap-3 mb-4">
					<img src="/assets/uboss-logo-light.png" alt="UBOSS" class="h-9 md:h-12 w-auto" width="160" height="48" />
					<img src="/assets/pegasus-icon-modern.jpg" alt="" class="h-9 md:h-11 w-auto object-contain opacity-60" width="44" height="44" aria-hidden="true" />
				</a>
			...
			<div>
				...
				<ul class="space-y-2">
					<li><a href="/{lang}/about" class="text-sm hover:text-teal transition-colors">{links.about}</a></li>
					<li><a href="/{lang}/services" class="text-sm hover:text-teal transition-colors">{links.services}</a></li>
					<li><a href="/{lang}/pricing" class="text-sm hover:text-teal transition-colors">{links.pricing}</a></li>
					<li><a href="/{lang}/contact" class="text-sm hover:text-teal transition-colors">{links.contact}</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-2">
					<li><a href="/{lang}/support" class="text-sm hover:text-teal transition-colors">{footer.support as string}</a></li>
					<li><a href="/{lang}/careers" class="text-sm hover:text-teal transition-colors">{footer.careers as string}</a></li>
					<li>
