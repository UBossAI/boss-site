...
/**
 * Structural only — labels and descriptions live in the i18n files so every locale
 * renders a fully translated page shell even before its entries are written.
 *
 * Display order drives the tile grid: the first four fill a 2x2 grid, the one marked
 * `wide` spans the full width beneath them.
 */
